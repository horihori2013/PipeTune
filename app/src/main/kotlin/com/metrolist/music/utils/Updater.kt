...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/horihori2013/PipeTune"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Metrolist.apk" || name == "PipeTune.apk" -> "universal" to "foss"
                name == "Metrolist-with-Google-Cast.apk" || name == "PipeTune-with-Google-Cast.apk" -> "universal" to "gms"
